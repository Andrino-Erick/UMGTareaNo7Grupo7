...
<body>
    ...
    <main class="main-container">
        ...
        <section class="container-tarea">
            ...
            <button><a href="tarean1.php">Ingreso de Datos en Formulario</a> </button>
        </section>
        <!--Fin Sección Tarea 1-->
           ...
           <section class="container-tarea">
            ...
            <button><a href="tarean2.php">Ingreso de Datos nuevo, editar y eliminar </a> </button>
        </section>
        <!--Fin Sección Tarea 1-->
          ...
          <section class="container-tarea">
            ...
            <button><a href="tarean3.php">Ingreso de Datos nuevo, editar y eliminar </a> </button>
        </section>
        <!--Fin Sección Tarea 1-->
